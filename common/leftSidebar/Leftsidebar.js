          ...
          <div className="wrapper">
            <nav id="sidebar">
              <div className="sidebar-header textAlignCenter">
                <label  className="headerImage">iAssureIT</label>
              ...
              <ul className="list-unstyled components scrollBox" style={{height:  sidebarHeight+"px"}}>
                ...
                <li className="sidebarMenuText"  onClick={this.eventclk1.bind(this)}>
                  <a href="#Booking" data-toggle="collapse" className="menuContent"  aria-expanded="false" title="Driver Master">
                  ...
                  <ul className="collapse list-unstyled activeClass" id="Booking">
                    <li>
                      <a href="/booking" title="Booking Master">
                        <i className="fa fa-circle-o" />
                        <span className="sidebarMenuSubText">Booking Master </span>
                      </a>
                    </li>
                    <li>
                      <a href="/booking-details" title="Booking Details">
                        <i className="fa fa-circle-o" />
                ...
                <li className="sidebarMenuText"  onClick={this.eventclk1.bind(this)}>
                  <a href="#BookingMagement" data-toggle="collapse" className="menuContent" aria-expanded="false" title="Booking Management">
                    <i className="fa fa-address-book" />
                      <span className="iconTitle">Booking Management</span>
                    <i className="leftarrow rotate fa fa-angle-left  pull-right"></i>
                  </a>
                  <ul className="collapse list-unstyled activeClass" id="BookingMagement">
                 ...
                 <li className="sidebarMenuText"  onClick={this.eventclk1.bind(this)}>
                  ...
                  <ul className="collapse list-unstyled activeClass" id="MasterData">
                    <li>
                      <a href="/location-type" title="Location Master">
                        <i className="fa fa-circle-o" /> 
                        <span className="sidebarMenuSubText">Location Types</span>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="/brand" title="Brand Master">
                        <i className="fa fa-circle-o" /> 
                        <span className="sidebarMenuSubText">Vehicle Brand</span>
                      </a>
                    </li> 
                    <li>
                      <a href="/designation" title="Designation Master">
                        <i className="fa fa-circle-o" /> 
                        <span className="sidebarMenuSubText">Designations</span>
                      </a>
                    </li>  
                    <li>
                      <a href="/department" title="Department Master">
                        <i className="fa fa-circle-o" /> 
                    ...
                    <li>
                      <a href="/model" title="Model Master">
                        <i className="fa fa-circle-o" /> 
