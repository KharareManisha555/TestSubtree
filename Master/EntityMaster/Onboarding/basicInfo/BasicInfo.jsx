            ...
            <section className="content">
              <div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div className="nav-center OnboardingTabs col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <ul className="nav nav-pills vendorpills col-lg-10 col-lg-offset-2 col-md-8 col-md-offset-3 col-sm-12 col-xs-12">
                    <li className="active col-lg-3 col-md-3 col-sm-12 col-xs-12 transactionTab pdcls pdclsOne btn1">
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                          <div className="col-lg-12 col-md-12 col-sm-12 supplierForm">
                              ...
                              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls NOpadding-left NOpadding-right">
                                ...
                                <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left NOpadding-right">
                                  ...
                                  <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 panerror" >
                                    ...
                                    <input maxLength="10" type="text" id="TAN" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12 inputText" value={this.state.TAN} ref="TAN" name="TAN" onChange={this.handleChange} placeholder="NGPO02911G" />
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls ">
                              <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
                                ...
                                <input type="text" id="CIN" maxLength="21" className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12 inputText" placeholder="L12345MH2019PTC123456" value={this.state.CIN} ref="CIN" name="CIN" onChange={this.handleChange} />
                              </div>
                            </div>
                          </div>
                          <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls ">
                            ...
                            <div className="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos" id="LogoImageUpOne">
                                  <div><i className="fa fa-camera"></i> <br/><p>ADD LOGO</p></div>
                          ...
                          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pdcls ">
                            ...
                            <div className="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 brdlogos" id="LogoImageUpOne">
                                  <div><i className="fa fa-file"></i> <br/><p>ADD COI</p></div>
