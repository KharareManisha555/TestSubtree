...
export default class ListOfVehicles extends React.Component <{}, {}>{
	...
	searchVehicle(event) {
		...
		axios.get("/api/vehiclemaster/search/"+event.target.value)
			.then((response) => {
				this.setState({
					vehicleList   : response.data
				})
						...
						<section className="content">
							<div className="pageContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div className="box-header with-border col-lg-12 col-md-12 col-xs-12 col-sm-12 NOpadding-right">
									<h4 className="weighttitle col-lg-11 col-md-11 col-xs-11 col-sm-11 NOpadding-right">Vehicle List</h4>
								</div>
								<div className="col-lg-12 col-md-12 col-xs-12 col-sm-12 nopadding">
									<h5 className="box-title2 col-lg-2 col-md-11 col-sm-11 col-xs-12">Total Suppliers :&nbsp;&nbsp;<b>{this.state.vehicleCount}</b></h5>
									<h5 className="box-title2 col-lg-2 col-md-11 col-sm-11 col-xs-12">Filtered :&nbsp;&nbsp;<b>{this.state.vehicleList.length}</b></h5>
								</div>
									...
									<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div className="col-lg-3 col-md-12 col-sm-12 col-xs-12 pull-right" >
											<span className="blocking-span" >
												<input type="text" name="search" className="col-lg-8 col-md-8 col-sm-8 col-xs-12 Searchusers searchVehicle inputTextSearch outlinebox pull-right texttrans"
													...
													return (
														<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12  borderlist selected" key={index} onClick={this.ShowForm.bind(this)} name={index} data-child={data._id + '-' + index} id={data._id}>
															<div className="col-lg-2 col-md-2 col-sm-2 col-xs-2 supplierLogoDiv">
																<img src=" " className="supplierLogoImage1"></img>
															</div>
