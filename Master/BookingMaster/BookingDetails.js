                                        ...
                                        <div className="borderlist12">
                                            {
                                                this.state.personList.map((data, index) => {
                                                    ...
                                                    return (
                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 empContainer selected" key={index} onClick={this.ShowForm.bind(this)} name={index} data-child={data._id + '-' + index} id={data._id}>
