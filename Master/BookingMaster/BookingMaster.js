            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 bookingMasterContainer">
                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 pickupType nopadding">
                        <ul class="nav nav-tabs customNavBM col-lg-12 nopadding">
                          <li class="active col-lg-4 nopadding"><a data-toggle="tab" href="#home"><i class="fa fa-car" aria-hidden="true"></i>&nbsp;Outstation</a></li>
                          <li class=" col-lg-4 nopadding" ><a data-toggle="tab" href="#menu1"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;Local</a></li>
                          <li class=" col-lg-4 nopadding" ><a data-toggle="tab" href="#menu2"><i class="fa fa-plane" aria-hidden="true"></i>&nbsp;Airport</a></li>
                        </ul>

                        <div class="tab-content customTabContent col-lg-12">
