                                            ...
                                            <form className="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="twoFieldFormValid" >
                                                ...
                                                <div className="form-margin col-lg-6  col-md-6 col-sm-12 col-xs-12 pdcls">
                                                    <div  id="textFieldOne">
                                                        ...
                                                        <input type="text"  className="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" value={this.state.attributeName} ref={this.props.fields.attributeName} name="textFieldOne" onChange={this.handleChange.bind(this)} placeholder={this.props.fields.placeholder} required />
                                                    </div>
                                                </div>
                                                <br />
